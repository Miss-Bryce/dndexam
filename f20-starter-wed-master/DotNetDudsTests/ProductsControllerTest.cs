...
namespace DotNetDudsTests
{
    ...
    public class ProductsControllerTest
    {
        ...
        {
            //To test the Get Delete method, passes a valid ID and makes sure the view returned is 'Delete'
        }

        public void DeleteConfirmTest()
        {
            //Passes in product object and double checks item is removed from the database
